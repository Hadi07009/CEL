            ...
            <table style="width: 100%; border:none;border-width:0px">
                <tr class="pagetopTest">
                    <td style="width:100px;height:80px;">
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/logo_120_100.jpg" />
                    </td>
                    <td colspan="4" style="border:none; vertical-align:bottom; font-weight:normal; font-size:20pt;text-align:right; font-family:'Clarke Serifa'">                      
                        HRIS & PAYROLL SYSTEM
                    </td>
                </tr>
                <tr >
                ...
                <tr>
                    ...
                    <td style="text-align:left;vertical-align:top"  class="auto-style12" >
                        <asp:Panel ID="PanelLeft" runat="server" Height="100%" Width="100%" CssClass="loginLeft">
                            <table style="width:99%;" >
                                ...
                                <tr>
                                    <td colspan="3" class="auto-style10" style="font-family:'Helvetica Neue LT';color:gray">
                                         <p class="MsoNormal">
                                             <span style="font-family:HelveticaNeue LT 55 Roman; 
                                                text-align:left">Clarke Energy Bangladesh Ltd, Laila Tower, 12<sup>th</sup>Floor, 8 Gulshan Avenue, Gulshan-1, Dhaka-1212, Bangladesh. Tel.+88-02-9841638, 9857355, 9898837, Fax +88-02-984 6530                                                                                                 
                                             </span>                                             
                                         </p>
                    ...
                    <td style="text-align:left;vertical-align:top"  >
                        ...
                        <asp:Panel ID="PanelRight" runat="server" Height="250px" Width="450px" BackColor="white"  style="text-align: left" CssClass="loginRight">
