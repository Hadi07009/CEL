                    ...
                    <td colspan="2">
                        <table >
                            ...
                            <tr>
                                ...
                                <td style="width: 34px">&nbsp;</td>
                                <td style="text-align: left">
                                    <asp:FileUpload ID="upd_image" runat="server" Visible="False" Width="342px" />
                                </td>
                                <td style="text-align: left">
                                    <asp:Button ID="btngetimage" runat="server" onclick="btngetimage_Click" Text="Update Image" Visible="False" Width="93px" />
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 136px; text-align: right">&nbsp;</td>
                                <td style="width: 34px">&nbsp;</td>
                                <td style="text-align: left">
                                    <asp:Image ID="imgEmployee" runat="server" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" Height="200px" Visible="False" Width="200px" />
                                </td>
                                <td style="text-align: left">&nbsp;</td>
                            </tr>
                        </table>
