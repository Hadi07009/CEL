...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr >
        ...
        <td style="width: 5px; font-weight: 700;">
            :</td>
        <td  style="height: 10px;" colspan="4">
            <asp:RadioButtonList ID="rdolistreporttype" runat="server" style="font-size: small; margin-left: 0px;" Height="22px" Width="567px" AutoPostBack="True" OnSelectedIndexChanged="rdolistreporttype_SelectedIndexChanged" ForeColor="Black">
                
                
                <asp:ListItem Selected="True">Individual Employee Statement</asp:ListItem>
                <asp:ListItem>Employee Statement (All Employee)</asp:ListItem>
                <asp:ListItem>Employee Statement (Summary)</asp:ListItem>
                
                
                <asp:ListItem>Yearly Distribution</asp:ListItem>
                <asp:ListItem>Employee Wise Distribution</asp:ListItem>
                <asp:ListItem>Installment Report</asp:ListItem>
                <asp:ListItem>Installment Report(All Employee)</asp:ListItem>
            </asp:RadioButtonList>
        ...
        <td  style="height: 10px;" colspan="4">
            <table id="tblemployee" runat="server" style="width:137%;">
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 5px; font-size: small;">
            ...
            <ajaxToolkit:AutoCompleteExtender ID="txtserviceBill_AutoCompleteemployee" 
                ...
                ServiceMethod="GetEmployee" ServicePath="~/services/srvSystem.asmx"
                 ...
                 <tr>
                     ...
                     <td style="width: 554px; height: 12px; font-size: small; text-align: right;"><strong>Period</strong></td>
                     <td style="width: 5px; height: 12px; font-weight: 700;">:</td>
