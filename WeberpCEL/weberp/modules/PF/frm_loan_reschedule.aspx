            ...
            <tr>
                ...
                <td >
                    ...
                    <table id="Table1" runat="server" style="width: 100%;">
                        <tr>
                            <td style="text-align: right; width: 283px; font-size: small;">
                                <strong>Employee&nbsp;/Loan Id:</strong></td>
                    ...
                    <table id="tbldet" runat="server" style="text-align: center; width: 100%; border-left-width: 1px; border-bottom-width: 1px; border-right-width: 1px; vertical-align: middle">
                        <tr>
                            ...
                            <td style="width: 135px; text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblid" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                            </td>
                            <td style="width: 8%; text-align: right; font-size: small;">
                                Loan Ref No:</td>
                            <td style="text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblloan_ref" runat="server" Font-Size="17px" CssClass="strong" style="font-size: small"></asp:Label>
                                </span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 135px; text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblname" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                            </td>
                            <td style="width: 8%; text-align: right; font-size: small;">
                                Loan Amount:</td>
                            <td style="text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblloanamount" runat="server"  Font-Size="17px" CssClass="strong" style="font-size: small"></asp:Label>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 8%; text-align: right; font-size: small;">
                                Interest Rate:</td>
                            <td style="text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblinstrate" runat="server"  Font-Size="17px" CssClass="strong" style="font-size: small"></asp:Label>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td style="width: 8%; text-align: right; font-size: small;">Employee Organization:</td>
                            <td style="width: 135px; text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblorganization" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                            </td>
                            <td style="width: 8%; text-align: right;">
                                <span style="font-size: small">No Of Installment:</span></td>
                            <td style="text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblnoofinst" runat="server"  Font-Size="17px" CssClass="strong" style="font-size: small"></asp:Label>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 135px; text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblcompany" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                            </td>
                            <td style="width: 8%; text-align: right; font-size: small;">
                                Loan Given Date:</td>
                            <td style="text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblloandate" runat="server"  Font-Size="17px" CssClass="strong" style="font-size: small"></asp:Label>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 8%; text-align: right; font-size: small;">
                                Loan Status:</td>
                            <td style="text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblloanstatus" runat="server"  Font-Size="17px" CssClass="strong" style="font-size: small"></asp:Label>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width: 135px; text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblservicelen" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                            </td>
                            <td style="width: 8%; text-align: right; font-size: small;">
                                No Installment Given:</td>
                            <td style="text-align: left; background-color: #FFFFFF;">
                                <asp:Label ID="lblnoofinsgiven" runat="server"  Font-Size="17px" CssClass="strong" style="font-size: small"></asp:Label>
                                </span>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <AlternatingRowStyle BackColor="White" />
                        ...
                        <tr>
                            ...
                            <td style="height: 20px; width: 135px; font-size: small; text-align: left;">
                                ...
                                <asp:Label ID="lblclosingbal" runat="server" Text="Label" CssClass="strong"></asp:Label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="width: 135px; text-align: left; font-size: small;">
                                ...
                                <asp:Label ID="lblinsrate2" runat="server" Text="Label" CssClass="strong"></asp:Label>
                            </td>
                            <td style="width: 8%">&nbsp;</td>
                            <td style="width: 24%">&nbsp;</td>
                            <td style="width: 11%">&nbsp;</td>
                        ...
                        <tr>
                            ...
                            <td style="width: 135px; text-align: left;">
                                ...
                                <ew:CalendarPopup ID="cldinsdate" runat="server" BackColor="#FFC20F" Culture="English (United Kingdom)" DisableTextBoxEntry="False" Nullable="false" Width="95px">
