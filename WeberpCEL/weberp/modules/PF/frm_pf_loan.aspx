<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/masMain.master"  CodeFile="frm_pf_loan.aspx.cs" Inherits="frm_pf_loan"  EnableEventValidation="false" ValidateRequest="false"  %>
            ...
            <tr>
                ...
                <td valign="top">
                  <table>
                        ...
                        <tr>
                            <td style="text-align: right; width: 214px; font-size: small;">
                                <strong>Employee:</strong></td>
                            <td style="text-align: left; width: 496px;">
                                </span>
            ...
            <tr>
                <td>
                    ...
                    <table id="tbldet" runat="server" style="text-align: center; width: 100%; border-left-width: 1px; border-bottom-width: 1px; border-right-width: 1px; vertical-align: middle;">
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right; font-size: small;">Employee ID:</td>
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right; font-size: small;">Employee Name:</td>
                            <td style="text-align: left; background-color: #FFFFFF; width: 516px;">
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right; font-size: small;">Employee Designation:</td>
                            <td style="text-align: left; background-color: #FFFFFF; width: 516px;">
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right; font-size: small;">Employee Organization:</td>
                            <td style="text-align: left; background-color: #FFFFFF; width: 516px;">
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right; font-size: small;">Employee Company:</td>
                            <td style="text-align: left; background-color: #FFFFFF; width: 516px;">
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right; font-size: small;">Employee Joinning Date:</td>
                            <td style="text-align: left; background-color: #FFFFFF; width: 516px;">
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right;  font-size: small;">Service Length (Months):</td>
                            <td style="text-align: left; background-color: #FFFFFF; width: 516px;">
                        ...
                        <tr>
                            <td style="width: 213px; font-size: small;">&nbsp;</td>
                        ...
                        <tr>
                            <td style="width: 213px; text-align: right; font-size: small;">PF Contribution Detail:</td>
...
&nbsp;
                    <asp:Button ID="btnpayschedule" runat="server" OnClick="btnpayschedule_Click" Text="Show Payment Schedule" Width="193px" />
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                         <ew:CalendarPopup ID="cldloandate" runat="server" BackColor="#FFC20F" Culture="English (United Kingdom)" DisableTextBoxEntry="False"  Nullable="false"  Width="95px">
