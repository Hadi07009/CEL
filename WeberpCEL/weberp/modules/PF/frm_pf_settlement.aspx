    ...
    <asp:UpdatePanel ID="updpnl" runat="server">
        <ContentTemplate>
            ...
            <table style="text-align: center; width: 100%; border-left-width: 1px; border-bottom-width: 1px; border-right-width: 1px; vertical-align: middle">
                ...
                <tr>
                    <td class="cpHeaderContent" style="width: 1230px">PF&nbsp; SETTLEMENT ENTRY </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: left; width: 1230px;">
                        <table style="width: 100%">
                            <tr>
                                <td style="width: 144px">&nbsp;</td>
                                <td style="width: 156px; text-align: right; font-weight: 700; font-size: small;">Employee</td>
                            ...
                            <tr>
                                <td style="width: 144px">&nbsp;</td>
                                <td style="width: 156px; text-align: right; font-weight: 700; font-size: small;">Settlement Date</td>
                                <td style="width: 7px">:</td>
                                <td>
                        ...
                        <table id="tblempbasicinfo" runat="server" style="width: 75%; font-size: small;">
                            ...
                            <tr>
                                ...
                                <td style="width: 149px">
                                    <asp:Label ID="lblempid" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                                </td>
                                <td style="width: 165px; text-align: right;">Employee Name</td>
                                <td style="width: 7px">:</td>
                                <td style="width: 224px">
                                    <asp:Label ID="lblempname" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                                    &nbsp;&nbsp;&nbsp;
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td style="width: 7px">:</td>
                                <td style="width: 149px">
                                    <asp:Label ID="lbldesignation" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                                </td>
                                <td style="width: 165px; text-align: right;">Department</td>
                                <td style="width: 7px">:</td>
                                <td style="width: 224px">
                                    <asp:Label ID="lbldepartment" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                                </td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            <tr>
                                ...
                                <td style="width: 7px">:</td>
                                <td style="width: 149px">
                                    <asp:Label ID="lbljoindate" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                                </td>
                                <td style="width: 165px; text-align: right;">Job Length(Month)</td>
                                <td style="width: 7px">:</td>
                                <td style="width: 224px">
                                    <asp:Label ID="lbljoblength" runat="server" Style="font-size: small" CssClass="strong"></asp:Label>
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                            <tr>
                         ...
                         <table id="tblpfcontribution" runat="server" style="width: 95%; font-size: small;">
                             <tr>
                                 <td style="color: #333333; text-align: center; background-color: #CCCCCC;" colspan="12" class="topcolor">Contribution</td>
                                 <td rowspan="9" style="width: 20%" valign="top">
                                     <table style="width: 100%; border: 2px solid; border-color:orange ">
                                         <tr>
                                             <td style="font-size: x-small; text-align: right; width: 117px;">Total Due</td>
                                             <td>:</td>
                                             <td>
                                         ...
                                         <tr>
                                             <td style="font-size: x-small; text-align: right; width: 117px;">Total Adjustment</td>
                                             <td>:</td>
                                             <td>
                                         ...
                                         <tr>
                                             <td style="font-size: x-small; text-align: right; width: 117px;">Total Payment</td>
                                             <td>:</td>
                                             <td>
                                         ...
                                         <tr>
                                             <td style="font-size: x-small; text-align: right; width: 117px;">Total Forfeited</td>
                                             <td>&nbsp;</td>
                                             <td>
                                                 <asp:Label ID="lbltotff" runat="server" CssClass="strong" Style="font-size: small" Text="payment"></asp:Label>
                                             </td>
                                         </tr>
                                         <tr>
                                             <td style="font-size: x-small; text-align: right; width: 117px;">Balance</td>
                                             <td>:</td>
                                             <td>
                             ...
                             <tr>
                                 ...
                                 <td style="width: 8%; height: 25px; font-weight: 700; font-size: x-small;">Adjust</td>
                                 <td style="width: 8%; height: 25px; font-weight: 700; font-size: x-small;">Forfieted</td>
                                 ...
                                 <td style="height: 25px; width: 9%; font-weight: 700; font-size: x-small;">Forfieted</td>
                            ...
                            <tr>
                                ...
                                <td style="width: 8%; height: 27px;">
                                    <asp:Label ID="lblownadj" runat="server" Style="font-size: 14px"></asp:Label>
                                </td>
                                <td style="width: 8%; height: 27px;">
                                    <asp:Label ID="lblownff" runat="server" Style="font-size: 14px"></asp:Label>
                                </td>
                                <td style="width: 8%; height: 27px;">
                                    <asp:Label ID="lblowndue" runat="server" Style="font-size: 14px"></asp:Label>
                                </td>
                                <td style="width: 9%; height: 27px;">
                                    <asp:TextBox ID="txtownadjustment" runat="server" Width="65px" AutoPostBack="True" OnTextChanged="txtownadjustment_TextChanged">0</asp:TextBox>
                                ...
                                <td style="width: 9%; height: 27px;">
                                    <asp:TextBox ID="txtownactualpay" runat="server" Width="65px" AutoPostBack="True" OnTextChanged="txtownactualpay_TextChanged">0</asp:TextBox>
                                ...
                                <td style="width: 9%; height: 27px;">
                                    <asp:TextBox ID="txtownff" runat="server" AutoPostBack="True"  Width="65px" OnTextChanged="txtownff_TextChanged">0</asp:TextBox>
                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtownactualpay0_FilteredTextBoxExtender" runat="server" Enabled="True" FilterMode="ValidChars" FilterType="Custom, Numbers" TargetControlID="txtownff" ValidChars=".">
                                    </ajaxToolkit:FilteredTextBoxExtender>
                            ...
                            <tr>
                                ...
                                <td style="width: 8%">
                                    <asp:Label ID="lblcomadj" runat="server" Style="font-size: 14px"></asp:Label>
                                </td>
                                <td style="width: 8%">
                                    <asp:Label ID="lblcomff" runat="server" Style="font-size: 14px"></asp:Label>
                                </td>
                                <td style="width: 8%">
                                    <asp:Label ID="lblcomdue" runat="server" Style="font-size: 14px"></asp:Label>
                                </td>
                                <td style="width: 9%">
                                    <asp:TextBox ID="txtcomnadjustment" runat="server" Width="65px" AutoPostBack="True" OnTextChanged="txtcomnadjustment_TextChanged">0</asp:TextBox>
                                ...
                                <td style="width: 9%">
                                    <asp:TextBox ID="txtcomactualpay" runat="server" Width="65px" AutoPostBack="True" OnTextChanged="txtcomactualpay_TextChanged">0</asp:TextBox>
                                ...
                                <td style="width: 9%">
                                    <asp:TextBox ID="txtcomff" runat="server" AutoPostBack="True" Width="65px" OnTextChanged="txtcomff_TextChanged">0</asp:TextBox>
                                    <ajaxToolkit:FilteredTextBoxExtender ID="txtownff0_FilteredTextBoxExtender" runat="server" Enabled="True" FilterMode="ValidChars" FilterType="Custom, Numbers" TargetControlID="txtcomff" ValidChars=".">
                                    </ajaxToolkit:FilteredTextBoxExtender>
                                </td>
                            ...
                            <tr>
                             ...
                             <tr>
                                 <td colspan="12" style="text-align: center; color: #333333; background-color: #CCCCCC;" class="topcolor">Profit</td>
                             </tr>
                             <tr>
                                 <td style="width: 6%">&nbsp;</td>
                                 ...
                                 <td style="width: 8%"><b style="font-size: x-small">Paid</b></td>
                                  <td style="width: 8%"><b style="font-size: x-small">Adjust</b></td>
                                 <td style="width: 8%"><b style="font-size: x-small">Forfieted</b></td>
                                 ...
                                 <td style="width: 9%"><b style="font-size: x-small">Forfieted</b> </td>
                             ...
                             <tr>
                                 ...
                                 <td style="width: 8%">
                                     <asp:Label ID="lblownadjpro" runat="server" Style="font-size: 14px"></asp:Label>
                                 </td>
                                 <td style="width: 8%">
                                     <asp:Label ID="lblownffpro" runat="server" Style="font-size: 14px"></asp:Label>
                                 </td>
                                 <td style="width: 8%">
                                     <asp:Label ID="lblownduepro" runat="server" Style="font-size: 14px"></asp:Label>
                                 </td>
                                 <td style="width: 9%">
                                     <asp:TextBox ID="txtownadjustmentpro" runat="server" AutoPostBack="True" OnTextChanged="txtownadjustmentpro_TextChanged" Width="65px">0</asp:TextBox>
                                 ...
                                 <td style="width: 9%">
                                     <asp:TextBox ID="txtownactualpaypro" runat="server" AutoPostBack="True" OnTextChanged="txtownactualpaypro_TextChanged" Width="65px">0</asp:TextBox>
                                 ...
                                 <td style="width: 9%">
                                     <asp:TextBox ID="txtownffpro" runat="server" AutoPostBack="True" Width="65px" OnTextChanged="txtownffpro_TextChanged">0</asp:TextBox>
                                     <ajaxToolkit:FilteredTextBoxExtender ID="txtcomff0_FilteredTextBoxExtender" runat="server" Enabled="True" FilterMode="ValidChars" FilterType="Custom, Numbers" TargetControlID="txtownffpro" ValidChars=".">
                                     </ajaxToolkit:FilteredTextBoxExtender>
                                 </td>
                                 <td style="width: 100px">
                             ...
                             <tr>
                                 ...
                                 <td style="width: 8%">
                                     <asp:Label ID="lblcomadjpro" runat="server" Style="font-size: 14px"></asp:Label>
                                 </td>
                                 <td style="width: 8%">
                                     <asp:Label ID="lblcomffpro" runat="server" Style="font-size: 14px"></asp:Label>
                                 </td>
                                 <td style="width: 8%">
                                     <asp:Label ID="lblcomduepro" runat="server" Style="font-size: 14px"></asp:Label>
                                 </td>
                                 <td style="width: 9%">
                                     <asp:TextBox ID="txtcomadjustmentpro" runat="server" OnTextChanged="txtcomadjustmentpro_TextChanged" AutoPostBack="true" Width="65px">0</asp:TextBox>
                                 ...
                                 <td style="width: 9%">
                                     <asp:TextBox ID="txtcomactualpaypro" runat="server" AutoPostBack="True" OnTextChanged="txtcomactualpaypro_TextChanged" Width="65px">0</asp:TextBox>
                                 ...
                                 <td style="width: 9%">
                                     <asp:TextBox ID="txtcomffpro" runat="server" AutoPostBack="True" Width="65px" OnTextChanged="txtcomffpro_TextChanged">0</asp:TextBox>
                                     <ajaxToolkit:FilteredTextBoxExtender ID="txtcomff1_FilteredTextBoxExtender" runat="server" Enabled="True" FilterMode="ValidChars" FilterType="Custom, Numbers" TargetControlID="txtcomffpro" ValidChars=".">
                                     </ajaxToolkit:FilteredTextBoxExtender>
                                 </td>
                                 <td style="width: 100px">
                  ...
                  <Triggers>
                      <asp:PostBackTrigger ControlID="btnstatement" />
                       <%--<asp:PostBackTrigger ControlID="btshow" />--%>
                     <%-- <asp:PostBackTrigger ControlID="btshow" />--%>


                      <asp:AsyncPostBackTrigger ControlID="btshow" EventName="Click" />
                      <asp:AsyncPostBackTrigger ControlID="btnsettlement" EventName="Click" />
