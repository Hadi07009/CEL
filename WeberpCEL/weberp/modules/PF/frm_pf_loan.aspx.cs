...
public partial class frm_pf_loan : System.Web.UI.Page
{
    ...
    {
        if ((txtloanamount.Text == "") || (txtnoofinst.Text == "") || (txtinstrate.Text == ""))
        {
            lblmessage.Text = "Entry error";
    ...
    protected void btnshow_Click(object sender, EventArgs e)
    {
        ...
        if (txtemployee.Text == "")
        {
            tbldet.Visible =false;
            tblloandet.Visible = false;
            lblmessage.Text = "Please enter valid employee code.";
            lblmessage.ForeColor = System.Drawing.Color.Red;
        ...
        if (dtloan_hdr.Rows.Count > 0)
        {
            ...
            tbldet.Visible = true;
            tblloandet.Visible = false;
            lblmessage.Text = "Already loan taken by  " + lblid.Text +":"+ lblname.Text;
            lblmessage.ForeColor = System.Drawing.Color.Red;
            return;
