<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmBusinessLeaveApproval.aspx.cs" Inherits="modules_HRMS_Approval_frmBusinessLeaveApproval" %>
         ...
         <ContentTemplate>
             <div align="center">
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            <asp:GridView ID="GridViewLeavePending" runat="server" AutoGenerateColumns="False"
                                                ...
                                                OnSelectedIndexChanged="GridViewLeavePending_SelectedIndexChanged" OnRowCommand="GridViewLeavePending_RowCommand">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Attendance" HeaderStyle-HorizontalAlign="Left"
                                                        HeaderText="Type" ItemStyle-HorizontalAlign="Left">
                                                        <HeaderStyle HorizontalAlign="Left" />
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:BoundField>
                                                    <asp:BoundField DataField="noofdays" HeaderStyle-HorizontalAlign="Center"
                                                        HeaderText="Duration" ItemStyle-HorizontalAlign="Center">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:BoundField>
                 ...
                 <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtenderSrch" runat="server"
                                ...
                                CollapsedText="Pending Business Leave Application"
                                ExpandedText="Pending Business Leave Application"
                                AutoCollapse="False"
                                AutoExpand="false"
             ...
             <asp:Panel ID="Panel50" runat="server" Width="100%">
                 <div align="center">
                     <asp:Panel ID="PanelLeaveHdr" runat="server" CssClass="cpHeaderContent" Width="100%">
                          <asp:Label ID="lblleave" Text="BUSINESS LEAVE APPLICATION DETAILS" runat="server" />
                     </asp:Panel>
                                                ...
                                                <asp:GridView ID="grdOvertime" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Select"
                                                            ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="CheckRet" runat="server" Checked="True" />
                                                            </ItemTemplate>
                                                            <HeaderStyle HorizontalAlign="Center" />
                                                            <ItemStyle HorizontalAlign="Center" />
                                                        </asp:TemplateField>
                                                ...
                                                <table style="width: 100%;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left">
                                                            ...
                                                            <asp:Button ID="btnForward" runat="server" OnClick="btnForward_Click" OnClientClick="ShowConfirmBox(this,'Are you sure to forward business leave ?'); return false;"
                                                                Text="Forward" Width="100px" />
                                                            <asp:Button ID="btnReturn" runat="server" OnClick="btnReturn_Click" OnClientClick="ShowConfirmBox(this,'Are you sure to return business leave ?'); return false;"
                                                                Text="Return" Width="100px" />
                                                            <asp:Button ID="btnReject" runat="server" OnClick="btnReject_Click" OnClientClick="ShowConfirmBox(this,'Are you sure to reject business leave ?'); return false;"
                                                                Text="Reject" Width="100px" />
                                                            <asp:Button ID="btnApprove" runat="server" OnClick="btnApprove_Click" OnClientClick="ShowConfirmBox(this,'Are you sure to approve business leave ?'); return false;"
                     ...
                     <cc1:CollapsiblePanelExtender ID="CollapsiblePanelExtender2" runat="server"
                                    ...
                                    CollapsedText="BUSINESS LEAVE APPLICATION DETAILS"
                                    ExpandedText="BUSINESS LEAVE APPLICATION DETAILS"
                                    AutoCollapse="False"
                                    AutoExpand="false"
