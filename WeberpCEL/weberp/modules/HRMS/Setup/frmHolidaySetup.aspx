                ...
                <table style="width: 99%; text-align: left">
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="OVERFLOW-Y: scroll; WIDTH: 380px; HEIGHT: 175px; border: 1px solid; border-color: #669999; border-style: Ridge">
                                ...
                                <asp:CheckBoxList ID="chkofficelocation" runat="server" AutoPostBack="True" OnSelectedIndexChanged="chkofficelocation_SelectedIndexChanged">
                                </asp:CheckBoxList>
                            </div>
                        </td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="4">
                            <div style="OVERFLOW-Y: scroll; WIDTH: 380px; HEIGHT: 250px; border: 1px solid; border-color: #669999; border-style: Ridge;">
