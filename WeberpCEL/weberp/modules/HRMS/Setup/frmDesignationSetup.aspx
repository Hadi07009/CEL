            ...
            <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Width="100%" Height="100%">
                <table style="width: 99%; text-align: left">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:TextBox ID="txtRank" onkeypress="return isNumberKey(event)" runat="server" Width="374px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style1" style="width: 107px">
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="EmpType">
                                     ...
                                     <asp:TemplateField HeaderText="Rank">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRank" runat="server" Text='<%# Bind("T_C2") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
