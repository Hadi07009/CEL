<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmAITDeductions.aspx.cs" Inherits="modules_HRMS_Payroll_frmAITDeductions" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="updpnl2" runat="server">
                ...
                <asp:Label ID="lblleave" Text="AIT DEDUCTION" runat="server" />
            </asp:Panel>
            <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Width="100%" Height="100%">
                <table style="width: 99%; text-align: left">
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td>
                            <asp:Button ID="btnUploadAttachment" runat="server" OnClick="btnUploadAttachment_Click" OnClientClick="ShowConfirmBox(this,'Are you Sure, Upload AIT Deduction?'); return false;" Text="Upload Attachment" Width="150px" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 168px">&nbsp;</td>
                        ...
                        <td colspan="3">
                            <asp:GridView ID="grdTaxChallan" runat="server" AutoGenerateColumns="False" Width="100%" OnRowCommand="grdTaxChallan_RowCommand" OnRowDeleting="grdTaxChallan_RowDeleting" OnRowDataBound="grdTaxChallan_RowDataBound" ShowFooter="True">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="AIT Amount">
                                        <ItemTemplate>
                    ...
                    <tr>
                        ...
                        <Triggers>
                            ...
                            <asp:PostBackTrigger ControlID="btnRemoveAllAIT" />
