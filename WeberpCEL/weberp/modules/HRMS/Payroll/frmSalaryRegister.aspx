<%@ Page Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmSalaryRegister.aspx.cs" Inherits="modules_HRMS_Payroll_frmSalaryRegister" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="updpnl2" runat="server">
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <table id="tbldet" runat="server" style="width: 100%;">
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSalreportPosted" runat="server" CssClass="btn2" OnClick="btnSalreportPosted_Click"
                                            Text="Salary Register Preview" Width="300px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnDisbursementLetter" runat="server" CssClass="btn2" OnClick="btnDisbursementLetter_Click" Text="Disbursement Letter" Width="300px" />
                                    </td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="btnDisbursementLetter" />
