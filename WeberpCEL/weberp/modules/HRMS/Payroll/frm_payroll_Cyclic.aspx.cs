...
public partial class modules_HRMS_Payroll_frm_payroll_Cyclic : System.Web.UI.Page
{
    ...
    protected void btnpost_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //PF Loan Installment update
            DataProcess.UpdateQuery(Session[GlobalData.sessionConnectionstring].ToString(), SqlgenerateForPayroll.pfLoanInstallmentUpdate(Convert.ToDateTime(dtForSal1.Rows[0][1].ToString()).Month, Convert.ToDateTime(dtForSal1.Rows[0][1].ToString()).Year));
