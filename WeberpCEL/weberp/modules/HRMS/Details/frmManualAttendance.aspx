                            ...
                            <div style="width: 800px">
                                <div style="width: 400px; float: left">
                                    <table style="width: 100%;">
                                        <tr>
                                            <td colspan="3">
                                                <asp:Panel ID="Panel2" runat="server" CssClass="cpHeaderContent">
                                                    <asp:Label ID="Label2" runat="server" Text="Entry Criteria"></asp:Label>
                                                </asp:Panel>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <cc1:AutoCompleteExtender ID="txtEmployeeCode_AutoCompleteExtender"
                                                    runat="server"
                                ...
                                <div style="width: 400px; float: right">
                                    <table style="width: 100%;">
                                        <tr>
                                            <td colspan="3">
                                                <asp:Panel ID="Panel1" runat="server" CssClass="cpHeaderContent">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <ew:CalendarPopup ID="calenderFromDate" runat="server" AutoPostBack="True" Culture="English (United Kingdom)" Enabled="true" Width="203px">
                                                    <MonthHeaderStyle BackColor="#2A2965" />
                                                    <ButtonStyle CssClass="btn2" />
                                                </ew:CalendarPopup>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <ew:CalendarPopup ID="calenderToDate" runat="server" AutoPostBack="True" Culture="English (United Kingdom)" 
                                                    Enabled="true" Width="203px">
                                                    <MonthHeaderStyle BackColor="#2A2965" />
                                                    <ButtonStyle CssClass="btn2" />
                                                </ew:CalendarPopup>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:DropDownList ID="ddlDepartment" runat="server" Width="240px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label10" runat="server" Text="Employee Code"></asp:Label>
                                            </td>
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="txtEmployeeCodeForSearch" runat="server" AutoPostBack="True" OnTextChanged="txtEmployeeCodeForSearch_TextChanged" Width="235px"></asp:TextBox>
                        ...
                        <td colspan="3">
                            <table style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <asp:TextBox ID="txtRemarks" runat="server" Height="75px" Style="margin-top: 0px" TextMode="MultiLine" Width="600px"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                            &nbsp;</td>
