...
public partial class modules_HRMS_Details_frm_AbsentList_Report : System.Web.UI.Page
{
    ...
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        selectionfor = "{hrms_AbsentList_byDept.Userid}='" + "ADM" + "'";//"{hrms_AbsentList_byDept.Userid}='" + Session[GlobalData.SessionUserId].ToString() + "'";
    ...
    private void CallAbsentListSp()
    {
        ...
        empid = "ADM";//Session[GlobalData.SessionUserId].ToString();
