                                ...
                                <asp:Panel ID="PanelTransferBody" runat="server" Height="160px" Width="100%">
                                    <table style="width: 50%; text-align: left">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:DropDownList ID="ddlOfficeLocation" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlOfficeLocation_SelectedIndexChanged" Width="250px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlDepartmentCode" runat="server" AutoPostBack="True"
                                                    OnSelectedIndexChanged="ddlDepartmentCode_SelectedIndexChanged" Width="250px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:DropDownList ID="ddlSectionCode" runat="server" Width="250px">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td style="height: 29px">
                                                <asp:TextBox ID="popupTransferredDate" runat="server" placeholder="Joining Date" Width="250px"></asp:TextBox>
                                ...
                                <asp:Panel ID="PanelPromotionBody" runat="server" Height="175px" Width="100%">
                                    <table style="width: 55%; text-align: left">
                                        ...
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:DropDownList ID="ddlDesignation" runat="server" Width="250px" AutoPostBack="True">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>:</td>
                                            <td>
                                                <asp:TextBox ID="popupPromotionDate" runat="server" placeholder="Joining Date" Width="250px"></asp:TextBox>
