        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelLeaveDet" runat="server" CssClass="cpBodyContent" Width="100%" Height="100%">
                <table style="width: 99%; text-align: left">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:Panel ID="PanelForEmployeeDetails" runat="server" Height="200px" ScrollBars="None" Width="100%">
                                <div style="text-align: center">
                                    <asp:Panel ID="PanelForDetailsHeader" runat="server" CssClass="cpHeaderContent" ScrollBars="None" Width="100%">
                                        EMPLOYEE DETAILS
                                    </asp:Panel>
                                    <asp:Panel ID="PanelForEmployeeDetailsBody" runat="server" Height="200px" Width="100%" ScrollBars="None">
                                    ...
                                    <asp:Panel ID="panelAdTBody" runat="server" Height="150px" Width="100%" ScrollBars="None">
                                        <div style="text-align: center">
                                            <table style="width: 50%;">
                                                ...
                                                <tr>
                                                    <td style="width: 115px; text-align: left">
                                                        <asp:Label ID="Label10" runat="server" Text="Mode of Payment"></asp:Label>
                                                    </td>
                                                    <td>:</td>
                                                    <td style="text-align: left">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td style="text-align: left">
                                                        <asp:Label ID="lblMaximumPerAllow" runat="server"></asp:Label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td style="text-align: left">
                        ...
                        <td colspan="3">
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <asp:Label ID="lblAvailableLeave" runat="server"></asp:Label>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <asp:TextBox ID="txtAddressDuringLeave" runat="server" Width="516px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label22" runat="server" Text="Contact Number During Leave"></asp:Label>
                                    </td>
                                    <td>:</td>
                                    <td>
                                        <asp:TextBox ID="txtContactNumber" runat="server" Width="407px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="Label23" runat="server" Text="Responsible Person During Leave"></asp:Label>
                                    </td>
                                    <td>:</td>
                                    <td>
                                        <asp:TextBox ID="txtResponsiblePerson" runat="server" Width="407px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <asp:TextBox ID="txtRemarks" runat="server" Height="75px" TextMode="MultiLine" Width="600px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
