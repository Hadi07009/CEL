<%@ Page Title="" Language="C#" MasterPageFile="~/masMain.master" AutoEventWireup="true" CodeFile="frmAttendanceIndividualViewAdmin.aspx.cs" Inherits="Modules_HRMS_SelfService_frmAttendanceIndividualViewAdmin" %>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <cc1:AutoCompleteExtender ID="txtEmployeeCode_AutoCompleteExtender" runat="server" 
                                                        ...
                                                        ServiceMethod="GetEmpId" ServicePath="~/modules/Payroll/WebService.asmx" TargetControlID="txtEmployeeCode">
                                                    </cc1:AutoCompleteExtender>
                                                    <asp:DropDownList ID="ddlEmployeeId" runat="server" Width="50px" Visible="False">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                        ...
                        <td colspan="3">
                            <asp:GridView ID="grdHoliday" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="totalHours" HeaderText="Extra Hour(If or more than 30 minutes)" HeaderStyle-Width="200px" />
                                    ...
                                    <asp:BoundField DataField="LateMinute" HeaderText="Late By" />
                                    <asp:BoundField DataField="EarlyMInute" HeaderText="Early By" />
