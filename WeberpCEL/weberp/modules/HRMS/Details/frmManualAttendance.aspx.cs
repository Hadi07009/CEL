...
public partial class modules_HRMS_Details_frmManualAttendance : System.Web.UI.Page
{
    ...
    public string Save(string connectionString, ManualAttendance objManualAttendance)
    {
        ...
        try
        {
            DataTable dtManualAttendance = DataProcess.GetData(connectionString, Sqlgenerate.SqlGetEmployeeAttendanceRecord(objManualAttendance.EmployeeCode, objManualAttendance.DateForAttendance,"A"));
            if (dtManualAttendance.Rows.Count == 0)
            {
            ...
            {
                SearchAttendanceRecord(objManualAttendance.DateForAttendance, objManualAttendance.DateForAttendance, objManualAttendance.EmployeeCode, "-1");
