...
public partial class modules_HRMS_Details_frmAttendanceTransfer : System.Web.UI.Page
{
    ...
    protected void btnImport_Click(object sender, EventArgs e)
    {
        ...
        msg1 = "Head office no data found";
        msg2 = "Branch office no data found";
        msg3 = "";
        ...
        msg1=ImportDataHeadoffice();
        //if (msg1=="")
        
        msg2=ImportDataBranchoffice();
    ...
    private string ImportDataBranchoffice()
    {
        string msg = "";
        var conn = new OleDbConnection(_connectionStringAccessAushulia);
        ...
        try
        {
            ...
            msg = "Branch office Data found:" + horowfetch.ToString() + " Insert:" + horowinsert.ToString();
    ...
    private string ImportDataHeadoffice()
    {
        string msg = "";
        ...
        try
        {
            ...
            horowinsert=DataProcess.ExecuteQueryNoofRoweffect(_connectionString, sqlchk);

            msg = "HO Data found:" + horowfetch.ToString() + " Insert:" + horowinsert.ToString();
