...
public partial class Modules_HRMS_SelfService_frmAttendanceIndividualView : System.Web.UI.Page
{
    ...
    private void LoadOvertimeDetailsemployeeID(string empid, string Processid, string flowid, DateTime fDate, DateTime lDate)
    {
        ...
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "spProcessGetAttendanceStatusIndividualView";
    ...
    private void PreviewData()
    {
        ...
        string parameter = CompanyName + ";" + CompanyAddress + ";" + ID + ";" + Name + ";" + Department + ";" + Designation+";"+JoiningDate;
