...
public partial class ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmLeaveApplication : System.Web.UI.Page
{
    string ConnectionStr = System.Configuration.ConfigurationManager.AppSettings["UbasysConnectionString"].ToString();
    string PID = "P001";
    string FID = "1";
    DateTime firstDateForAbsent = Convert.ToDateTime("01-01-" + DateTime.Now.Year + "");
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            if (!Page.IsPostBack)
            {
                ...
                GetTotalAbsentOfEmployee(Session["ApplicantID"].ToString(), PID, FID, firstDateForAbsent, lDate);
                GetTotalLateOfEmployee(Session["ApplicantID"].ToString(), PID, FID, firstDateForAbsent, lDate);
            }
    ...
    private void GetTotalAbsentOfEmployee(string empid, string Processid, string flowid, DateTime fDate, DateTime lDate)
    {
        DataTable dt = new DataTable();
        SqlCommand cmd = new SqlCommand();
        SqlConnection sqlConn = null;
        ...
        cmd.Connection = sqlConn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "spProcessCountAttendanceAbsentStatusByEmpid";
        cmd.Parameters.Add(new SqlParameter("@fDate", SqlDbType.DateTime)).Value = fDate;
        cmd.Parameters.Add(new SqlParameter("@lDate ", SqlDbType.DateTime)).Value = lDate;
        cmd.Parameters.Add(new SqlParameter("@empid", SqlDbType.NVarChar)).Value = empid;
        cmd.Parameters.Add(new SqlParameter("@processid", SqlDbType.NVarChar)).Value = Processid;
        ...
        da.Fill(dt);
        sqlConn.Close();
        btnAbsentCount.Text = string.Empty;
        if (dt.Rows.Count > 0)
        {
            btnAbsentCount.Text = dt.Rows[0][0].ToString();

        }
    }

    private void GetTotalLateOfEmployee(string empid, string Processid, string flowid, DateTime fDate, DateTime lDate)
    {
        DataTable dt = new DataTable();
        SqlCommand cmd = new SqlCommand();
        SqlConnection sqlConn = null;
        ...
        cmd.Connection = sqlConn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "spProcessCountLateAbsentStatusByEmpid";
        cmd.Parameters.Add(new SqlParameter("@fDate", SqlDbType.DateTime)).Value = fDate;
        cmd.Parameters.Add(new SqlParameter("@lDate ", SqlDbType.DateTime)).Value = lDate;
        cmd.Parameters.Add(new SqlParameter("@empid", SqlDbType.NVarChar)).Value = empid;
        cmd.Parameters.Add(new SqlParameter("@processid", SqlDbType.NVarChar)).Value = Processid;
        ...
        da.Fill(dt);
        sqlConn.Close();
        btnCountLate.Text = string.Empty;
        if (dt.Rows.Count > 0)
        {
            btnCountLate.Text = dt.Rows[0][0].ToString();

        }
    }

    private void LoadAbsentDetailsemployeeID(string empid, string Processid, string flowid, DateTime fDate, DateTime lDate)
    {
        DataTable dt = new DataTable();
        SqlCommand cmd = new SqlCommand();
        SqlConnection sqlConn = null;
        ...
        cmd.Connection = sqlConn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "spProcessGetAttendanceAbsentStatusByEmpid";
        cmd.Parameters.Add(new SqlParameter("@fDate", SqlDbType.DateTime)).Value = fDate;
        cmd.Parameters.Add(new SqlParameter("@lDate ", SqlDbType.DateTime)).Value = lDate;
        cmd.Parameters.Add(new SqlParameter("@empid", SqlDbType.NVarChar)).Value = empid;
        cmd.Parameters.Add(new SqlParameter("@processid", SqlDbType.NVarChar)).Value = Processid;
    ...
    private void LoadLateDetailsemployeeID(string empid, string Processid, string flowid, DateTime fDate, DateTime lDate)
    {
        DataTable dt = new DataTable();
        SqlCommand cmd = new SqlCommand();
        SqlConnection sqlConn = null;
        ...
        cmd.Connection = sqlConn;
        cmd.CommandType = CommandType.StoredProcedure;
        cmd.CommandText = "spProcessGetAttendanceLateStatusByEmpid";
        cmd.Parameters.Add(new SqlParameter("@fDate", SqlDbType.DateTime)).Value = fDate;
        cmd.Parameters.Add(new SqlParameter("@lDate ", SqlDbType.DateTime)).Value = lDate;
        cmd.Parameters.Add(new SqlParameter("@empid", SqlDbType.NVarChar)).Value = empid;
        cmd.Parameters.Add(new SqlParameter("@processid", SqlDbType.NVarChar)).Value = Processid;
        ...
        try
        {
            ...
            for (int i = 0; i < GridViewLeave.Rows.Count; i++)
            {
                ...
                if (chkbox.Checked == true)
                {
                    ...
                    offphdr.SysIntime = lblIntime.Text == "&nbsp;" ? "00:00 AM" : (lblIntime.Text == "" ? "00:00 AM" : lblIntime.Text);
                    offphdr.SysOuttime = lblOuttime.Text == "&nbsp;" ? "00:00 AM" : (lblOuttime.Text == "" ? "00:00 AM" : lblOuttime.Text);


                    offphdr.SysTotalhrs = lblHours.Text == "&nbsp;" ? "00:00" : (lblHours.Text == "" ? "00:00" : lblHours.Text);
    ...
    {
        if (DateProcess.CheckValidDate(txtFromDate.Text) == false)
        {
            txtFromDate.Text = DateProcess.FirstDateOfMonth(DateProcess.GetServerDate(ConnectionStr)).ToShortDateString();
        }
        if (DateProcess.CheckValidDate(txtToDate.Text) == false)
        {
            txtToDate.Text = DateProcess.LastDateOfMonth(DateProcess.GetServerDate(ConnectionStr)).ToShortDateString();
        }
    ...
    protected void btnAbsentCount_Click(object sender, EventArgs e)
    {
        try
        {
            DateTime lDate = Convert.ToDateTime(ReturnDecissinon().Split('@')[1]);
            LoadAbsentDetailsemployeeID(Session["ApplicantID"].ToString(), PID, FID, firstDateForAbsent, lDate);
        }
        catch (Exception msgException)
        {
    ...
    protected void btnCountLate_Click(object sender, EventArgs e)
    {
        try
        {
            DateTime lDate = Convert.ToDateTime(ReturnDecissinon().Split('@')[1]);
            LoadLateDetailsemployeeID(Session["ApplicantID"].ToString(), PID, FID, firstDateForAbsent, lDate);
        }
        catch (Exception msgException)
        {
