...
public partial class ClientSide_modules_mis_naz_FORMS_HRMS_Forms_frmLeaveApplicationAdmin : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {           
            ...
            txtEmpId_AutoCompleteExtender.ContextKey = ConnectionStr.ToString();                  
    ...
    private string SendMailtoApprover(string leavedate, string leavetype, double leavedays)
    {
        ...
        try
        {
            ...
            if (leavedays > 1)
                ...
                lvd = leavedays + " day";
            string msgbody = "I have applied " + lvd + "(" + leavedate + ") " + "(" + leavetype + ")" + " leave application in MIS is pending for your approval.";
    ...
    protected void btnShow_Click(object sender, EventArgs e)
    {
        ...
        Session["ApplicantID"] = employeeid.ToString();
