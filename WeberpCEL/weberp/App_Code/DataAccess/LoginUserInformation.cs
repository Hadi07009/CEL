...
public class LoginUserInformation
{
    ...
    {
        var storedProcedureCommandText = "exec [EmpBasicInformationGetFromHrms_Emp_Photo] '" + userId + "','CEL'";
        return StoredProcedureExecutor.StoredProcedureExecuteReader(connectionString, storedProcedureCommandText);
